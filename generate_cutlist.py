...
def generate_cutlist(mus, preview_length=30, filename='previews.csv'):
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '-o',
        help='Output filename for the cut-list (default is previews.csv)',
        type=str,
    ...
    generate_cutlist(mus, args.duration, args.o)
